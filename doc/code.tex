...
\>MATRIXSS_GetPartialBaseSGS( generators, ssInfo, identity, field ) F
...
\>MATRIXSS_ComputeSchreierTree( tree, generators, action ) F
...
\>MATRIXSS_ComputeOrder( ssInfo ) F
...
\>RandomSchreierSims( ssInfo, partialSGS, maxIdentitySifts, identity, low_order, high_order, nScrambles, RattleFactor ) F
...
\>MATRIXSS_SchreierToddCoxeterSims( ssInfo, partialSGS, level, identity ) F
