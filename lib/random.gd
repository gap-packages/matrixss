###############################################################################
##
#W    random.gd  The Matrix Schreier Sims package 
...
Revision.("matrixss/lib/random_gd") := 
  "@(#)$Id$";

# The random Schreier-Sims algorithm for matrix groups
# Input:
#      G - a matrix group
#      p - lower bound for probability of correct solution
...
#                           O'Brien and Murray.
DeclareGlobalFunction("MatrixRandomSchreierSims");
